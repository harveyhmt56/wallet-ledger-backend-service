...
Steps 3–6 remain subject to the [pending remediation and release gates](memory/state.md#pending-remediation), including error classification, history audit fields, messaging durability/recovery, promotion contention and controlled production adoption of V4.
